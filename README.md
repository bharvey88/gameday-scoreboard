...
- Live scoreboard at kickoff: scores, gold abbreviation for the team with the ball, timeout pips, and a scrolling ticker with the clock, down and distance, and the last play
